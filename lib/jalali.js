...
JalaliDate.jalaliToPersian = function(y, m, d) {
    var arr = [y, m, d];
    if (y == null || m == null || d == null) {
        var d = new Date();
        arr = JalaliDate.gregorianToJalali(d.getFullYear(), d.getMonth() + 1, d.getDate());
    }


    var str = JalaliDate.j_days_in_persian[(new Date().getDay())];
    str += ' ';
    str += arr[2];
    str += ' ';
    str += JalaliDate.j_months_in_persian[arr[1]];
    str += ' ';
    str += arr[0];
    str += ' ';
